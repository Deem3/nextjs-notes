      ...
      <div className="relative top-24 mx-60">
        <div className="border-solid border-2 border-sky-600 bg-sky-600 flex flex-col items-center">
          <form onSubmit={handleSubmit} className="pt-4">
            ...
            <input className="rounded-md relative left-20 w-48" type="text" onChange={(e) => setTitle(e.target.value)} />
            <br />
            ...
            />
            <br />
            <button className="relative mb-4 font-bold left-32 text-2xl hover:text-neutral-700">Create Note</button>
          </form>
        </div>
      </div>
    </>
